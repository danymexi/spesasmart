...
const styles = StyleSheet.create({
  ...
  emptyTitle: { marginTop: 12, marginBottom: 8, color: "#1a1a1a" },
  emptyText: { color: "#555", textAlign: "center", marginBottom: 16 },
  title: { fontWeight: "bold", marginHorizontal: 16, marginTop: 16, color: "#1a1a1a" },
  brand: { color: glassColors.greenMedium, marginHorizontal: 16, marginTop: 4 },
  subtitle: { marginHorizontal: 16, marginTop: 16, marginBottom: 8, color: "#444", fontWeight: "600" },
  offerCard: {
    marginHorizontal: 12,
    marginBottom: 10,
    padding: 16,
